...
contract factoryICO is Ownable{
    ...
    constructor(uint _ICOCreationFee,
    ...
    function updateVestingInfo(Vesting memory _VestingInfo) public onlyOwner {
    ...
    function lengthOfICO() public view returns (uint) {
        return allICOListing.length;
    }

    function userInfo() public view returns (uint[] memory) {
        return userAllInfo[msg.sender];
    }

    function InvestorInfo() public view returns (uint[] memory) {
        return investorInfo[msg.sender];
    }

    function userProjectNames() public view returns (string[] memory) {
